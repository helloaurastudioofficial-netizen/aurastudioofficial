...
import type { OrderRecord as _OrderRecord, Status as _Status, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getOrderById(arg0: string): Promise<OrderRecord> {
        if (this.processError) {
            try {
                ...
                return from_candid_OrderRecord_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitOrder(arg0: OrderRecord): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOrder(to_candid_OrderRecord_n18(this._uploadFile, this._downloadFile, arg0));
    ...
    async updateOrderStatus(arg0: string, arg1: Status): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateOrderStatus(arg0, to_candid_Status_n20(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_OrderRecord_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderRecord): _OrderRecord {
